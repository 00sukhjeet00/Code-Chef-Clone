...
export default function SideBar() {
  return (
    ...
    <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
      <h2 className='sidebar-brand brand-logo' style={{color:"#fff"}}>Sci-Fi</h2>
      <p className="sidebar-brand brand-logo-mini" style={{fontSize:"18px",color:"#fff"}}>Sci-Fi</p>
    ...
    <ul className="nav">
      ...
      <li className="nav-item menu-items">
        <a className="nav-link" href="/contest">
          ...
          <span className="menu-title">Contest</span>
        </a>
      </li>
      <li className="nav-item menu-items">
